...
$(document).ready(function() {
    ...
    sr.reveal('.revealopacity', {opacity:0, duration: 1200});
    sr.reveal('.revealopacity2', {opacity:0, delay: 75, duration: 1200});
    sr.reveal('.revealopacity3', {opacity:0, delay: 150, duration: 1200});
    sr.reveal('.revealopacity4', {opacity:0, delay: 200, duration: 1200});
    })