...
// $.ajax({
//     url: 'https://api.dribbble.com/v2/user/shots?access_token='+43595dd2dbf04bd0ddfa7515e6c1fe6f4d0866660a00775c261c94f665f8a2e2,
//     dataType: 'json',
//     type: 'GET',
...
//                     ''
//                 )
//             }).users('coreymines').shots({'per_page': 3}).then(function(shots) {
//   var html = [];
